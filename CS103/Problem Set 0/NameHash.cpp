...
/* This is the actual function that computes the hash code. You can 
 * think of it as a function that scrambles up the characters
 * of the input and produces a number.
 *
 * For those of you who are curious, this function treats each character 
 * in the input name as a number between 0 and 128.
 ...
 * some smaller prime number q. (You aren't expected to know this for CS103,
